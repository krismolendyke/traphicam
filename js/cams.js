  ...
  Cams = (function() {
    ...
    function Cams() {
      ...
      if (navigator.geolocation) {
        ...
        navigator.geolocation.watchPosition(this.watchSuccess);
      }
      $('button#reverse').click(__bind(function() {
        return this.load();
      }, this));
    }
    Cams.prototype.watchSuccess = function(position) {
      ...
      if (!(positionLatLng.equals(this.lastPositionLatLng) || position.coords.accuracy > difference)) {
        ...
        return this.positionList.append($('script#position-item').tmpl(position));
      }
    };
    Cams.prototype.geoLocSuccess = function(position) {
      ...
      return $('span#destination').text("to " + destination);
    };
