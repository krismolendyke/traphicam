/*!
 * jQuery Mobile v Git Buildn * Git Info SHA1: 823485ce11ebb28dadf2b3b51f23f305ba0b314b Date: Sun Jun 19 14:34:36 2011 -0400
...
n="@media "+a+" { #jquery-mediatest { position:absolute; } }";l.type="text/css";l.styleSheet?l.styleSheet.cssText=n:l.appendChild(document.createTextNode(n));b.prepend(d).prepend(l);c[a]=e.css("position")==="absolute";d.add(l).remove()}return c[a]}}();a.mobile.addResolutionBreakpoints=function(b){a.type(b)==="array"?e=e.concat(b):e.push(b);e.sort(function(a,b){return a-b});d()};a(document).bind("mobileinit.htmlclass",function(){c.bind("orientationchange.htmlclass throttledResize.htmlclass",function(a){a.orientation&&
...
(function(a,d,c,b){function e(a){for(;a&&typeof a.originalEvent!=="undefined";)a=a.originalEvent;return a}function f(b){for(var c={};b;){var e=a.data(b,o),d;for(d in e)if(e[d])c[d]=c.hasVirtualBinding=!0;b=b.parentNode}return c}function g(){w&&(clearTimeout(w),w=0);w=setTimeout(function(){A=w=0;t.length=0;r=!1;B=!0},a.vmouse.resetTimerDuration)}function i(c,d,r){var f=!1,g;if(!(g=r&&r[c])){if(r=!r)a:{for(r=d.target;r;){if((g=a.data(r,o))&&(!c||g[c]))break a;r=r.parentNode}r=null}g=r}if(g){f=d;r=f.type;
f=a.Event(f);f.type=c;var h=f.originalEvent,j=a.event.props;if(h)for(c=j.length;c;)g=j[--c],f[g]=h[g];if(r.search(/^touch/)!==-1&&(c=e(h),r=c.touches,c=c.changedTouches,r=r&&r.length?r[0]:c&&c.length?c[0]:b)){c=0;for(h=x.length;c<h;c++)g=x[c],f[g]=r[g]}a(d.target).trigger(f);f=f.isDefaultPrevented()}return f}function h(b){var c=a.data(b.target,y);!r&&(!A||A!==c)&&i("v"+b.type,b)}function l(b){var c=e(b).touches;if(c&&c.length===1){var d=b.target,c=f(d);if(c.hasVirtualBinding)A=F++,a.data(d,y,A),w&&
(clearTimeout(w),w=0),z=B=!1,d=e(b).touches[0],v=d.pageX,s=d.pageY,i("vmouseover",b,c),i("vmousedown",b,c)}}function n(a){B||(z||i("vmousecancel",a,f(a.target)),z=!0,g())}function p(b){if(!B){var c=e(b).touches[0],d=z,r=a.vmouse.moveDistanceThreshold;z=z||Math.abs(c.pageX-v)>r||Math.abs(c.pageY-s)>r;c=f(b.target);z&&!d&&i("vmousecancel",b,c);i("vmousemove",b,c);g()}}function j(a){if(!B){B=!0;var b=f(a.target);i("vmouseup",a,b);if(!z&&i("vclick",a,b)){var c=e(a).changedTouches[0];t.push({touchID:A,
x:c.clientX,y:c.clientY});r=!0}i("vmouseout",a,b);z=!1;g()}}function k(b){var b=a.data(b,o),c;if(b)for(c in b)if(b[c])return!0;return!1}function q(){}function m(b){var c=b.substr(1);return{setup:function(){k(this)||a.data(this,o,{});a.data(this,o)[b]=!0;u[b]=(u[b]||0)+1;u[b]===1&&C.bind(c,h);a(this).bind(c,q);if(E)u.touchstart=(u.touchstart||0)+1,u.touchstart===1&&C.bind("touchstart",l).bind("touchend",j).bind("touchmove",p).bind("scroll",n)},teardown:function(){--u[b];u[b]||C.unbind(c,h);E&&(--u.touchstart,
u.touchstart||C.unbind("touchstart",l).unbind("touchmove",p).unbind("touchend",j).unbind("scroll",n));var d=a(this),e=a.data(this,o);e&&(e[b]=!1);d.unbind(c,q);k(this)||d.removeData(o)}}}var o="virtualMouseBindings",y="virtualTouchID",d="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" "),x="clientX clientY pageX pageY screenX screenY".split(" "),u={},w=0,v=0,s=0,z=!1,t=[],r=!1,B=!1,E=a.support.eventCapture,C=a(c),F=1,A=0;a.vmouse={moveDistanceThreshold:10,clickDistanceThreshold:10,
resetTimerDuration:1500};for(var D=0;D<d.length;D++)a.event.special[d[D]]=m(d[D]);E&&c.addEventListener("click",function(b){var c=t.length,d=b.target;if(c)for(var e=b.clientX,r=b.clientY,f=a.vmouse.clickDistanceThreshold,g=d;g;){for(var h=0;h<c;h++){var j=t[h];if(g===d&&Math.abs(j.x-e)<f&&Math.abs(j.y-r)<f||a.data(g,y)===j.touchID){b.preventDefault();b.stopPropagation();return}}g=g.parentNode}},!0)})(jQuery,window,document);
...
f){e=f;c(d,e?"scrollstart":"scrollstop",a)}var d=this,e,f;a(d).bind("touchmove scroll",function(c){a.event.special.scrollstart.enabled&&(e||b(c,!0),clearTimeout(f),f=setTimeout(function(){b(c,!1)},50))})}};a.event.special.tap={setup:function(){var b=this,d=a(b);d.bind("vmousedown",function(a){function e(){g=!1;clearTimeout(q);d.unbind("vclick",f).unbind("vmousecancel",e)}function f(a){e();k==a.target&&c(b,"tap",a)}if(a.which&&a.which!==1)return!1;var g=!0,k=a.target,q;d.bind("vmousecancel",e).bind("vclick",
f);q=setTimeout(function(){g&&c(b,"taphold",a)},750)})}};a.event.special.swipe={setup:function(){var b=a(this);b.bind(e,function(c){function e(a){if(p){var b=a.originalEvent.touches?a.originalEvent.touches[0]:a;j={time:(new Date).getTime(),coords:[b.pageX,b.pageY]};Math.abs(p.coords[0]-j.coords[0])>10&&a.preventDefault()}}var n=c.originalEvent.touches?c.originalEvent.touches[0]:c,p={time:(new Date).getTime(),coords:[n.pageX,n.pageY],origin:a(c.target)},j;b.bind(g,e).one(f,function(){b.unbind(g,e);
p&&j&&j.time-p.time<1E3&&Math.abs(p.coords[0]-j.coords[0])>30&&Math.abs(p.coords[1]-j.coords[1])<75&&p.origin.trigger("swipe").trigger(p.coords[0]>j.coords[0]?"swipeleft":"swiperight");p=j=d})})}};(function(a){function b(){var a=d();a!==e&&(e=a,c.trigger("orientationchange"))}var c=a(window),d,e;a.event.special.orientationchange={setup:function(){if(a.support.orientation)return!1;e=d();c.bind("throttledresize",b)},teardown:function(){if(a.support.orientation)return!1;c.unbind("throttledresize",b)},
...
(function(a,d,c){function b(a){a=a||location.href;return"#"+a.replace(/^[^#]*#?(.*)$/,"$1")}var e="hashchange",f=document,g,i=a.event.special,h=f.documentMode,l="on"+e in d&&(h===c||h>7);a.fn[e]=function(a){return a?this.bind(e,a):this.trigger(e)};a.fn[e].delay=50;i[e]=a.extend(i[e],{setup:function(){if(l)return!1;a(g.start)},teardown:function(){if(l)return!1;a(g.stop)}});g=function(){function g(){var c=b(),f=o(k);if(c!==k)m(k=c,f),a(d).trigger(e);else if(f!==k)location.href=location.href.replace(/#.*/,
"")+f;j=setTimeout(g,a.fn[e].delay)}var h={},j,k=b(),i=function(a){return a},m=i,o=i;h.start=function(){j||g()};h.stop=function(){j&&clearTimeout(j);j=c};a.browser.msie&&!l&&function(){var c,d;h.start=function(){if(!c)d=(d=a.fn[e].src)&&d+b(),c=a('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){d||m(b());g()}).attr("src",d||"javascript:0").insertAfter("body")[0].contentWindow,f.onpropertychange=function(){try{if(event.propertyName==="title")c.document.title=f.title}catch(a){}}};
h.stop=i;o=function(){return b(c.location.href)};m=function(b,d){var g=c.document,j=a.fn[e].domain;if(b!==d)g.title=f.title,g.open(),j&&g.write('<script>document.domain="'+j+'"<\/script>'),g.close(),c.location.hash=b}}();return h}()})(jQuery,this);
...
(function(a,d){function c(a){var b=a.jqmData("lastClicked");b&&b.length?b.focus():(b=a.find(".ui-title:eq(0)"),b.length?b.focus():a.find(o).eq(0).focus())}function b(b){q&&(!q.closest(".ui-page-active").length||b)&&q.removeClass(a.mobile.activeBtnClass);q=null}function e(){x=!1;y.length>0&&a.mobile.changePage.apply(null,y.pop())}function f(b,d,e,f){var j=n.scrollTop(),h=b.data("lastScroll")||a.mobile.defaultHomeScroll;j&&window.scrollTo(0,a.mobile.defaultHomeScroll);h<a.mobile.minScrollBack&&(h=0);
d&&(d.height(screen.height+j).jqmData("lastScroll",j).jqmData("lastClicked",q),d.data("page")._trigger("beforehide",null,{nextPage:b}));b.height(screen.height+h).data("page")._trigger("beforeshow",null,{prevPage:d||a("")});a.mobile.hidePageLoadingMsg();e=(a.mobile.transitionHandlers[e||"none"]||a.mobile.defaultTransitionHandler)(e,f,b,d);e.done(function(){b.height("");h?(a.mobile.silentScroll(h),a(document).one("silentscroll",function(){c(b)})):c(b);d&&d.height("").data("page")._trigger("hide",null,
{nextPage:b});b.data("page")._trigger("show",null,{prevPage:d||a("")});g()});return e}function g(){var b=jQuery.event.special.orientationchange.orientation()==="portrait",c=b?screen.height:screen.width,b=Math.max(b?480:320,a(window).height()),c=Math.min(c,b);a(".ui-page-active").css("min-height",c)}function i(b,c){c&&b.attr("data-"+a.mobile.ns+"role",c);b.page()}function h(a){for(;a;){if(a.nodeName.toLowerCase()=="a")break;a=a.parentNode}return a}function l(b){var b=a(b).closest(".ui-page").jqmData("url"),
c=s.hrefNoHash;if(!b||!k.isPath(b))b=c;return k.makeUrlAbsolute(b,c)}var n=a(window),p=a("html"),j=a("head"),k={urlParseRE:/^(((([^:\/#\?]+:)?(?:\/\/((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?]+)(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,parseUrl:function(a){if(typeof a==="object")return a;var a=k.urlParseRE.exec(a),b;a&&(b={href:a[0]||"",hrefNoHash:a[1]||"",hrefNoSearch:a[2]||"",domain:a[3]||"",protocol:a[4]||"",authority:a[5]||"",username:a[7]||"",password:a[8]||
"",host:a[9]||"",hostname:a[10]||"",port:a[11]||"",pathname:a[12]||"",directory:a[13]||"",filename:a[14]||"",search:a[15]||"",hash:a[16]||""});return b||{}},makePathAbsolute:function(a,b){if(a&&a.charAt(0)==="/")return a;for(var a=a||"",c=(b=b?b.replace(/^\/|\/?[^\/]*$/g,""):"")?b.split("/"):[],d=a.split("/"),e=0;e<d.length;e++){var f=d[e];switch(f){case ".":break;case "..":c.length&&c.pop();break;default:c.push(f)}}return"/"+c.join("/")},isSameDomain:function(a,b){return k.parseUrl(a).domain===k.parseUrl(b).domain},
isRelativeUrl:function(a){return k.parseUrl(a).protocol===""},isAbsoluteUrl:function(a){return k.parseUrl(a).protocol!==""},makeUrlAbsolute:function(a,b){if(!k.isRelativeUrl(a))return a;var c=k.parseUrl(a),d=k.parseUrl(b),e=c.protocol||d.protocol,f=c.authority||d.authority,g=c.pathname!=="",j=k.makePathAbsolute(c.pathname||d.filename,d.pathname);return e+"//"+f+j+(c.search||!g&&d.search||"")+c.hash},addSearchParams:function(b,c){var d=k.parseUrl(b),e=typeof c==="object"?a.param(c):c,f=d.search||"?";
return d.hrefNoSearch+f+(f.charAt(f.length-1)!=="?"?"&":"")+e+(d.hash||"")},convertUrlToDataUrl:function(a){var b=k.parseUrl(a);if(k.isEmbeddedPage(b))return b.hash.replace(/^#/,"");else if(k.isSameDomain(b,s))return b.hrefNoHash.replace(s.domain,"");return a},get:function(a){if(a===d)a=location.hash;return k.stripHash(a).replace(/[^\/]*\.[^\/*]+$/,"")},getFilePath:function(b){var c="&"+a.mobile.subPageUrlKey;return b&&b.split(c)[0].split(u)[0]},set:function(a){location.hash=a},isPath:function(a){return/\//.test(a)},
clean:function(a){return a.replace(s.domain,"")},stripHash:function(a){return a.replace(/^#/,"")},cleanHash:function(a){return k.stripHash(a.replace(/\?.*$/,"").replace(u,""))},isExternal:function(a){a=k.parseUrl(a);return a.protocol&&a.domain!==v.domain?!0:!1},hasProtocol:function(a){return/^(:?\w+:)/.test(a)},isEmbeddedPage:function(a){a=k.parseUrl(a);if(a.protocol!=="")return a.hash&&(a.hrefNoHash===v.hrefNoHash||z&&a.hrefNoHash===s.hrefNoHash);return/^#/.test(a.href)}},q=null,m={stack:[],activeIndex:0,
getActive:function(){return m.stack[m.activeIndex]},getPrev:function(){return m.stack[m.activeIndex-1]},getNext:function(){return m.stack[m.activeIndex+1]},addNew:function(a,b,c,d){m.getNext()&&m.clearForward();m.stack.push({url:a,transition:b,title:c,page:d});m.activeIndex=m.stack.length-1},clearForward:function(){m.stack=m.stack.slice(0,m.activeIndex+1)},directHashChange:function(b){var c,e,f;a.each(m.stack,function(a,d){b.currentUrl===d.url&&(c=a<m.activeIndex,e=!c,f=a)});this.activeIndex=f!==
d?f:this.activeIndex;c?b.isBack():e&&b.isForward()},ignoreNextHashChange:!1},o="[tabindex],a,button:visible,select:visible,input",y=[],x=!1,u="&ui-state=dialog",w=j.children("base"),v=k.parseUrl(location.href),s=w.length?k.parseUrl(k.makeUrlAbsolute(w.attr("href"),v.href)):v,z=v.hrefNoHash!==s.hrefNoHash,t=a.support.dynamicBaseTag?{element:w.length?w:a("<base>",{href:s.hrefNoHash}).prependTo(j),set:function(a){t.element.attr("href",k.makeUrlAbsolute(a,s))},reset:function(){t.element.attr("href",s.hrefNoHash)}}:
d;a.fn.animationComplete=function(b){return a.support.cssTransitions?a(this).one("webkitAnimationEnd",b):(setTimeout(b,0),a(this))};a.mobile.updateHash=k.set;a.mobile.path=k;a.mobile.base=t;a.mobile.urlstack=m.stack;a.mobile.urlHistory=m;a.mobile.noneTransitionHandler=function(b,c,d,e){e&&e.removeClass(a.mobile.activePageClass);d.addClass(a.mobile.activePageClass);return a.Deferred().resolve(b,c,d,e).promise()};a.mobile.defaultTransitionHandler=a.mobile.noneTransitionHandler;a.mobile.transitionHandlers=
{none:a.mobile.defaultTransitionHandler};a.mobile.allowCrossDomainPages=!1;a.mobile.getDocumentUrl=function(b){return b?a.extend({},v):v.href};a.mobile.getDocumentBase=function(b){return b?a.extend({},s):s.href};a.mobile.loadPage=function(b,c){var e=a.Deferred(),f=a.extend({},a.mobile.loadPage.defaults,c),g=null,j=null,h=k.makeUrlAbsolute(b,s.hrefNoHash);if(f.data&&f.type==="get")h=k.addSearchParams(h,f.data),f.data=d;var m=k.getFilePath(h),l=k.convertUrlToDataUrl(h);f.pageContainer=f.pageContainer||
a.mobile.pageContainer;g=f.pageContainer.children(":jqmData(url='"+l+"')");t&&t.reset();if(g.length){if(!f.reloadPage)return i(g,f.role),e.resolve(h,c,g),e.promise();j=g}f.showLoadMsg&&a.mobile.showPageLoadingMsg();a.ajax({url:m,type:f.type,data:f.data,dataType:"html",success:function(d){var q=a("<div></div>"),p=d.match(/<title[^>]*>([^<]*)/)&&RegExp.$1,n=RegExp("\\bdata-"+a.mobile.ns+"url=[\"']?([^\"'>]*)[\"']?");RegExp(".*(<[^>]+\\bdata-"+a.mobile.ns+"role=[\"']?page[\"']?[^>]*>).*").test(d)&&RegExp.$1&&
n.test(RegExp.$1)&&RegExp.$1&&(b=m=k.getFilePath(RegExp.$1));t&&t.set(m);q.get(0).innerHTML=d;g=q.find(":jqmData(role='page'), :jqmData(role='dialog')").first();p&&!g.jqmData("title")&&g.jqmData("title",p);if(!a.support.dynamicBaseTag){var o=k.get(m);g.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]").each(function(){var b=a(this).is("[href]")?"href":a(this).is("[src]")?"src":"action",c=a(this).attr(b),c=c.replace(location.protocol+"//"+location.host+location.pathname,
"");/^(\w+:|#|\/)/.test(c)||a(this).attr(b,o+c)})}g.attr("data-"+a.mobile.ns+"url",k.convertUrlToDataUrl(m)).appendTo(f.pageContainer);i(g,f.role);h.indexOf("&"+a.mobile.subPageUrlKey)>-1&&(g=f.pageContainer.children(":jqmData(url='"+l+"')"));f.showLoadMsg&&a.mobile.hidePageLoadingMsg();e.resolve(h,c,g,j)},error:function(){t&&t.set(k.get());f.showLoadMsg&&(a.mobile.hidePageLoadingMsg(),a("<div class='ui-loader ui-overlay-shadow ui-body-e ui-corner-all'><h1>"+a.mobile.pageLoadErrorMessage+"</h1></div>").css({display:"block",
opacity:0.96,top:n.scrollTop()+100}).appendTo(f.pageContainer).delay(800).fadeOut(400,function(){a(this).remove()}));e.reject(h,c)}});return e.promise()};a.mobile.loadPage.defaults={type:"get",data:d,reloadPage:!1,role:d,showLoadMsg:!0,pageContainer:d};a.mobile.changePage=function(c,g){if(typeof g!=="object"){var h=null;if(typeof c==="object"&&c.url&&c.type)h={type:c.type,data:c.data,forcePageLoad:!0},c=c.url;var j=arguments.length;if(j>1){var l=["transition","reverse","changeHash","fromHashChange"],
q;for(q=1;q<j;q++){var n=arguments[q];typeof n!=="undefined"&&(h=h||{},h[l[q-1]]=n)}}if(h)return a.mobile.changePage(c,h)}if(x)y.unshift(arguments);else{x=!0;var o=a.extend({},a.mobile.changePage.defaults,g);o.pageContainer=o.pageContainer||a.mobile.pageContainer;if(typeof c=="string")a.mobile.loadPage(c,o).done(function(b,c,d,e){x=!1;c.duplicateCachedPage=e;a.mobile.changePage(d,c)}).fail(function(){x=!1;b(!0);e();o.pageContainer.trigger("changepagefailed")});else{var v=o.pageContainer,h=a.mobile.activePage,
j=c.jqmData("url");k.getFilePath(j);l=m.getActive();q=m.activeIndex===0;var s=0,n=document.title,t=o.role==="dialog"||c.jqmData("role")==="dialog";v.trigger("beforechangepage");if(h&&h[0]===c[0])x=!1,v.trigger("changepage");else{i(c,o.role);o.fromHashChange&&m.directHashChange({currentUrl:j,isBack:function(){s=-1},isForward:function(){s=1}});a(document.activeElement||"").add("input:focus, textarea:focus, select:focus").blur();t&&l&&(j=l.url+u);if(o.changeHash!==!1&&j)m.ignoreNextHashChange=!0,k.set(j);
(t=c.jqmData("title")||c.children(":jqmData(role='header')").find(".ui-title").text())&&n==document.title&&(n=t);s||m.addNew(j,o.transition,n,c);document.title=m.getActive().title;a.mobile.activePage=c;o.transition=o.transition||(s&&!q?l.transition:d)||(o.role==="dialog"?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);o.reverse=o.reverse||s<0;f(c,h,o.transition,o.reverse).done(function(){b();o.duplicateCachedPage&&o.duplicateCachedPage.remove();p.removeClass("ui-mobile-rendering");
e();v.trigger("changepage")})}}}};a.mobile.changePage.defaults={transition:d,reverse:!1,changeHash:!0,fromHashChange:!1,role:d,duplicateCachedPage:d,pageContainer:d};a("form").live("submit",function(b){var c=a(this);if(a.mobile.ajaxEnabled&&!c.is(":jqmData(ajax='false')")){var d=c.attr("method"),e=k.makeUrlAbsolute(c.attr("action"),l(c));target=c.attr("target");!k.isExternal(e)&&!target&&(a.mobile.changePage(e,{type:d.length&&d.toLowerCase()||"get",data:c.serialize(),transition:c.jqmData("transition"),
direction:c.jqmData("direction"),reloadPage:!0}),b.preventDefault())}});a(document).bind("vclick",function(b){if((b=h(b.target))&&k.parseUrl(b.getAttribute("href")||"#").hash!=="#")a(b).closest(".ui-btn").not(".ui-disabled").addClass(a.mobile.activeBtnClass),a("."+a.mobile.activePageClass+" .ui-btn").not(b).blur()});a(document).bind("vclick click",function(c){var e=h(c.target);if(e){var f=a(e),g=function(){window.setTimeout(function(){b(!0)},200)};if(f.is(":jqmData(rel='back')"))return window.history.back(),
!1;if(a.mobile.ajaxEnabled){var j=l(f),e=k.makeUrlAbsolute(f.attr("href")||"#",j);if(e.search("#")!=-1)if(e=e.replace(/[^#]*#/,""))e=k.isPath(e)?k.makeUrlAbsolute(e,j):k.makeUrlAbsolute("#"+e,v.hrefNoHash);else{c.preventDefault();return}var j=f.is("[rel='external']")||f.is(":jqmData(ajax='false')")||f.is("[target]"),i=a.mobile.allowCrossDomainPages&&v.protocol==="file:"&&e.search(/^https?:/)!=-1,j=j||k.isExternal(e)&&!i;q=f.closest(".ui-btn");j?g():(g=f.jqmData("transition"),j=(j=f.jqmData("direction"))&&
j==="reverse"||f.jqmData("back"),f=f.attr("data-"+a.mobile.ns+"rel")||d,a.mobile.changePage(e,{transition:g,reverse:j,role:f}),c.preventDefault())}else g()}});n.bind("hashchange",function(){var b=k.stripHash(location.hash),c=a.mobile.urlHistory.stack.length===0?"none":d;if(!a.mobile.hashListeningEnabled||m.ignoreNextHashChange)m.ignoreNextHashChange=!1;else{if(m.stack.length>1&&b.indexOf(u)>-1)if(a.mobile.activePage.is(".ui-dialog")){var e=function(){b=a.mobile.urlHistory.getActive().page};m.directHashChange({currentUrl:b,
isBack:e,isForward:e})}else{m.directHashChange({currentUrl:b,isBack:function(){window.history.back()},isForward:function(){window.history.forward()}});return}b?(b=typeof b==="string"&&!k.isPath(b)?"#"+b:b,a.mobile.changePage(b,{transition:c,changeHash:!1,fromHashChange:!0})):a.mobile.changePage(a.mobile.firstPage,{transition:c,changeHash:!1,fromHashChange:!0})}});a(document).bind("pagecreate orientationchange",g)})(jQuery);
...
a("<a>",{href:"#",role:"button",id:n,"aria-haspopup":"true","aria-owns":p})).text(a(b[0].options.item(g)).text()).insertBefore(b).buttonMarkup({theme:c.theme,icon:c.icon,iconpos:c.iconpos,inline:c.inline,corners:c.corners,shadow:c.shadow,iconshadow:c.iconshadow}),h=d.isMultiple=b[0].multiple;c.nativeMenu&&window.opera&&window.opera.version&&b.addClass("ui-select-nativeonly");if(!c.nativeMenu){var l=b.find("option"),n=e+"-button",p=e+"-menu",j=b.closest(".ui-page"),g=/ui-btn-up-([a-z])/.exec(i.attr("class"))[1],
k=a("<div data-"+a.mobile.ns+"role='dialog' data-"+a.mobile.ns+"theme='"+c.menuPageTheme+"'><div data-"+a.mobile.ns+"role='header'><div class='ui-title'>"+f.text()+"</div></div><div data-"+a.mobile.ns+"role='content'></div></div>").appendTo(a.mobile.pageContainer).page(),q=k.find(".ui-content");k.find(".ui-header a");var m=a("<div>",{"class":"ui-selectmenu-screen ui-screen-hidden"}).appendTo(j),o=a("<div>",{"class":"ui-selectmenu ui-selectmenu-hidden ui-overlay-shadow ui-corner-all pop ui-body-"+
c.overlayTheme}).insertAfter(m),y=a("<ul>",{"class":"ui-selectmenu-list",id:p,role:"listbox","aria-labelledby":n}).attr("data-"+a.mobile.ns+"theme",g).appendTo(o),x=a("<div>",{"class":"ui-header ui-bar-"+g}).prependTo(o),u=a("<h1>",{"class":"ui-title"}).appendTo(x),w=a("<a>",{text:c.closeText,href:"#","class":"ui-btn-left"}).attr("data-"+a.mobile.ns+"iconpos","notext").attr("data-"+a.mobile.ns+"icon","delete").appendTo(x).buttonMarkup()}if(h)d.buttonCount=a("<span>").addClass("ui-li-count ui-btn-up-c ui-btn-corner-all").hide().appendTo(i);
c.disabled&&this.disable();b.change(function(){d.refresh()});a.extend(d,{select:b,optionElems:l,selectID:e,label:f,buttonId:n,menuId:p,thisPage:j,button:i,menuPage:k,menuPageContent:q,screen:m,listbox:o,list:y,menuType:void 0,header:x,headerClose:w,headerTitle:u,placeholder:""});c.nativeMenu?b.appendTo(i).bind("vmousedown",function(){i.addClass(a.mobile.activeBtnClass)}).bind("focus vmouseover",function(){i.trigger("vmouseover")}).bind("vmousemove",function(){i.removeClass(a.mobile.activeBtnClass)}).bind("change blur vmouseout",
function(){i.trigger("vmouseout").removeClass(a.mobile.activeBtnClass)}):(d.refresh(),b.attr("tabindex","-1").focus(function(){a(this).blur();i.focus()}),i.bind("vclick keydown",function(b){if(b.type=="vclick"||b.keyCode&&(b.keyCode===a.mobile.keyCode.ENTER||b.keyCode===a.mobile.keyCode.SPACE))d.open(),b.preventDefault()}),y.attr("role","listbox").delegate(".ui-li>a","focusin",function(){a(this).attr("tabindex","0")}).delegate(".ui-li>a","focusout",function(){a(this).attr("tabindex","-1")}).delegate("li:not(.ui-disabled, .ui-li-divider)",
"vclick",function(c){var e=b[0].selectedIndex,f=y.find("li:not(.ui-li-divider)").index(this),g=d.optionElems.eq(f)[0];g.selected=h?!g.selected:!0;h&&a(this).find(".ui-icon").toggleClass("ui-icon-checkbox-on",g.selected).toggleClass("ui-icon-checkbox-off",!g.selected);(h||e!==f)&&b.trigger("change");h||d.close();c.preventDefault()}).keydown(function(b){var c=a(b.target),d=c.closest("li");switch(b.keyCode){case 38:return b=d.prev(),b.length&&(c.blur().attr("tabindex","-1"),b.find("a").first().focus()),
!1;case 40:return b=d.next(),b.length&&(c.blur().attr("tabindex","-1"),b.find("a").first().focus()),!1;case 13:case 32:return c.trigger("vclick"),!1}}),m.bind("vclick",function(){d.close()}),d.headerClose.click(function(){if(d.menuType=="overlay")return d.close(),!1}))},_buildList:function(){var d=this,c=this.options,b=this.placeholder,e=[],f=[],g=d.isMultiple?"checkbox-off":"false";d.list.empty().filter(".ui-listview").listview("destroy");d.select.find("option").each(function(){var i=a(this),h=i.parent(),
l=i.text(),n="<a href='#'>"+l+"</a>",p=[],j=[];h.is("optgroup")&&(h=h.attr("label"),a.inArray(h,e)===-1&&(f.push("<li data-"+a.mobile.ns+"role='list-divider'>"+h+"</li>"),e.push(h)));if(!this.getAttribute("value")||l.length==0||i.jqmData("placeholder"))c.hidePlaceholderMenuItems&&p.push("ui-selectmenu-placeholder"),b=d.placeholder=l;this.disabled&&(p.push("ui-disabled"),j.push("aria-disabled='true'"));f.push("<li data-"+a.mobile.ns+"icon='"+g+"' class='"+p.join(" ")+"' "+j.join(" ")+">"+n+"</li>")});
...
"input"?parseFloat(c.val()):c[0].selectedIndex},n=g=="input"?parseFloat(c.attr("min")):0,p=g=="input"?parseFloat(c.attr("max")):c.find("option").length-1,j=window.parseFloat(c.attr("step")||1),k=a('<div class="ui-slider '+b+" ui-btn-down-"+f+' ui-btn-corner-all" role="application"></div>'),q=a('<a href="#" class="ui-slider-handle"></a>').appendTo(k).buttonMarkup({corners:!0,theme:e,shadow:!0}).attr({role:"slider","aria-valuemin":n,"aria-valuemax":p,"aria-valuenow":l(),"aria-valuetext":l(),title:l(),
"aria-labelledby":h});a.extend(this,{slider:k,handle:q,dragging:!1,beforeStart:null});g=="select"&&(k.wrapInner('<div class="ui-slider-inneroffset"></div>'),c.find("option"),c.find("option").each(function(b){var c=b==0?"b":"a",d=b==0?"right":"left",b=b==0?" ui-btn-down-"+f:" ui-btn-active";a('<div class="ui-slider-labelbg ui-slider-labelbg-'+c+b+" ui-btn-corner-"+d+'"></div>').prependTo(k);a('<span class="ui-slider-label ui-slider-label-'+c+b+" ui-btn-corner-"+d+'" role="img">'+a(this).text()+"</span>").prependTo(q)}));
i.addClass("ui-slider");c.addClass(g=="input"?"ui-slider-input":"ui-slider-switch").change(function(){d.refresh(l(),!0)}).keyup(function(){d.refresh(l(),!0,!0)}).blur(function(){d.refresh(l(),!0)});a(document).bind("vmousemove",function(a){if(d.dragging)return d.refresh(a),!1});k.bind("vmousedown",function(a){d.dragging=!0;if(g==="select")d.beforeStart=c[0].selectedIndex;d.refresh(a);return!1});k.add(document).bind("vmouseup",function(){if(d.dragging){d.dragging=!1;if(g==="select"){d.beforeStart===
c[0].selectedIndex&&d.refresh(d.beforeStart===0?1:0);var a=l(),a=Math.round(a/(p-n)*100);q.addClass("ui-slider-handle-snapping").css("left",a+"%").animationComplete(function(){q.removeClass("ui-slider-handle-snapping")})}return!1}});k.insertAfter(c);this.handle.bind("vmousedown",function(){a(this).focus()}).bind("vclick",!1);this.handle.bind("keydown",function(b){var c=l();if(!d.options.disabled){switch(b.keyCode){case a.mobile.keyCode.HOME:case a.mobile.keyCode.END:case a.mobile.keyCode.PAGE_UP:case a.mobile.keyCode.PAGE_DOWN:case a.mobile.keyCode.UP:case a.mobile.keyCode.RIGHT:case a.mobile.keyCode.DOWN:case a.mobile.keyCode.LEFT:if(b.preventDefault(),
!d._keySliding)d._keySliding=!0,a(this).addClass("ui-state-active")}switch(b.keyCode){case a.mobile.keyCode.HOME:d.refresh(n);break;case a.mobile.keyCode.END:d.refresh(p);break;case a.mobile.keyCode.PAGE_UP:case a.mobile.keyCode.UP:case a.mobile.keyCode.RIGHT:d.refresh(c+j);break;case a.mobile.keyCode.PAGE_DOWN:case a.mobile.keyCode.DOWN:case a.mobile.keyCode.LEFT:d.refresh(c-j)}}}).keyup(function(){if(d._keySliding)d._keySliding=!1,a(this).removeClass("ui-state-active")});this.refresh()},refresh:function(a,
...
l=a.support.cssPseudoElement||!a.nodeName(d[0],"ol")?0:1;l&&d.find(".ui-li-dec").remove();for(var n=0,p=h.length;n<p;n++){var j=h.eq(n),k="ui-li";if(c||!j.hasClass("ui-li")){var q=j.jqmData("theme")||b.theme,m=j.children("a");if(m.length){var o=j.jqmData("icon");j.buttonMarkup({wrapperEls:"div",shadow:!1,corners:!1,iconpos:"right",icon:m.length>1||o===!1?!1:o||"arrow-r",theme:q});m.first().addClass("ui-link-inherit");m.length>1&&(k+=" ui-li-has-alt",m=m.last(),o=g||m.jqmData("theme")||b.splitTheme,
m.appendTo(j).attr("title",m.text()).addClass("ui-li-link-alt").empty().buttonMarkup({shadow:!1,corners:!1,theme:q,icon:!1,iconpos:!1}).find(".ui-btn-inner").append(a("<span />").buttonMarkup({shadow:!0,corners:!0,theme:o,iconpos:"notext",icon:i||m.jqmData("icon")||b.splitIcon})))}else j.jqmData("role")==="list-divider"?(k+=" ui-li-divider ui-btn ui-bar-"+f,j.attr("role","heading"),l&&(l=1)):k+=" ui-li-static ui-body-"+q}b.inset&&(n===0&&(k+=" ui-corner-top",j.add(j.find(".ui-btn-inner")).find(".ui-li-link-alt").addClass("ui-corner-tr").end().find(".ui-li-thumb").addClass("ui-corner-tl"),
j.next().next().length&&this._removeCorners(j.next())),n===h.length-1&&(k+=" ui-corner-bottom",j.add(j.find(".ui-btn-inner")).find(".ui-li-link-alt").addClass("ui-corner-br").end().find(".ui-li-thumb").addClass("ui-corner-bl"),j.prev().prev().length&&this._removeCorners(j.prev())));l&&k.indexOf("ui-li-divider")<0&&(j.is(".ui-li-static:first")?j:j.find(".ui-link-inherit")).addClass("ui-li-jsnumbering").prepend("<span class='ui-li-dec'>"+l++ +". </span>");j.add(j.children(".ui-btn-inner")).addClass(k);
c||this._itemApply(d,j)}},_idStringEscape:function(a){return a.replace(/[^a-zA-Z0-9]/g,"-")},_createSubPages:function(){var c=this.element,b=c.closest(".ui-page"),e=b.jqmData("url"),f=e||b[0][a.expando],g=c.attr("id"),i=this.options,h="data-"+a.mobile.ns,l=b.find(":jqmData(role='footer')").jqmData("id");typeof d[f]==="undefined"&&(d[f]=-1);g=g||++d[f];a(c.find("li>ul, li>ol").toArray().reverse()).each(function(b){var d=a(this),f=d.attr("id")||g+"-"+b,b=d.parent(),k=a(d.prevAll().toArray().reverse()),
k=k.length?k:a("<span>"+a.trim(b.contents()[0].nodeValue)+"</span>"),q=k.first().text(),f=(e||"")+"&"+a.mobile.subPageUrlKey+"="+f;theme=d.jqmData("theme")||i.theme;countTheme=d.jqmData("counttheme")||c.jqmData("counttheme")||i.countTheme;newPage=d.detach().wrap("<div "+h+"role='page' "+h+"url='"+f+"' "+h+"theme='"+theme+"' "+h+"count-theme='"+countTheme+"'><div "+h+"role='content'></div></div>").parent().before("<div "+h+"role='header' "+h+"theme='"+i.headerTheme+"'><div class='ui-title'>"+q+"</div></div>").after(l?
a("<div "+h+"role='footer' "+h+"id='"+l+"'>"):"").parent().appendTo(a.mobile.pageContainer);newPage.page();d=b.find("a:first");d.length||(d=a("<a />").html(k||q).prependTo(b.empty()));d.attr("href","#"+f)}).listview()}})})(jQuery);
...
"url",b.attr("id"))});a.mobile.firstPage=b.first();a.mobile.pageContainer=b.first().parent().addClass("ui-mobile-viewport");a.mobile.showPageLoadingMsg();!a.mobile.hashListeningEnabled||!a.mobile.path.stripHash(location.hash)?a.mobile.changePage(a.mobile.firstPage,{transition:"none",reverse:!0,changeHash:!1,fromHashChange:!0}):e.trigger("hashchange",[!0])}});d.scrollTo(0,1);a.mobile.defaultHomeScroll=!a.support.scrollTop||a(d).scrollTop()===1?0:1;a(a.mobile.initializePage);e.load(a.mobile.silentScroll)}})(jQuery,
this);
